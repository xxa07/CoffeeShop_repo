<?php
// NOTE (Vulnerable build):
// - Plain session_start() with PHP defaults (no HttpOnly, no Secure, no SameSite).
// - No idle timeout: a captured PHPSESSID stays valid for hours.
session_start();
